...
class ActivitiesApi(object):
    ...
    def list_activities(self, **kwargs):  # noqa: E501
        """List activities and messages  # noqa: E501
        ...
        :param str task_id: Either the task unique `id` (UUID), or the task unique `index` (the 123 of T-123).
    ...
    def post_message(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param PostMessageRequest body: (required)
    ...
    def post_message_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ActivityObject',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
