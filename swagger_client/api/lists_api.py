...
class ListsApi(object):
    ...
    def create_list(self, body, **kwargs):  # noqa: E501
        ...
        :param CreateListRequest body: (required)
        :return: ListObject
    ...
    def create_list_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ListObject',  # noqa: E501
    ...
    def list_all_lists(self, **kwargs):  # noqa: E501
        """List all lists  # noqa: E501

        Use this endpoint to retrieve all the lists of the workspace. Only lists shared with the entire workspace will be returned.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_all_lists(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: list[ListAllResponse]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_all_lists_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_all_lists_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_all_lists_with_http_info(self, **kwargs):  # noqa: E501
        """List all lists  # noqa: E501

        Use this endpoint to retrieve all the lists of the workspace. Only lists shared with the entire workspace will be returned.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_all_lists_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ListAllResponse]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_list(self, body, id, **kwargs):  # noqa: E501
        """Update a list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_list(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateListRequest body: (required)
        :param str id: The unique id of the list (UUIDv4) (required)
        :return: ListObject
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_list_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_list_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_list_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update a list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_list_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
