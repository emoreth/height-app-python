...
class ListAllResponse(object):
    ...
    def __init__(self, list=None):  # noqa: E501
        """ListAllResponse - a model defined in Swagger"""  # noqa: E501
        self._list = None
    ...
    @property
    def list(self):
        """Gets the list of this ListAllResponse.  # noqa: E501


        :return: The list of this ListAllResponse.  # noqa: E501
        :rtype: list[ListObject]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this ListAllResponse.


        :param list: The list of this ListAllResponse.  # noqa: E501
        :type: list[ListObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListAllResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllResponse):
            return False
