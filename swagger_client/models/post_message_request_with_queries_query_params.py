...
class PostMessageRequestWithQueriesQueryParams(object):
    ...
    def __init__(self, realtime=True, notify_users=True):  # noqa: E501
        """PostMessageRequestWithQueriesQueryParams - a model defined in Swagger"""  # noqa: E501
        self._realtime = None
    ...
    @property
    def realtime(self):
        """Gets the realtime of this PostMessageRequestWithQueriesQueryParams.  # noqa: E501

        (defaults to true) - use false when migrating messages  # noqa: E501

        :return: The realtime of this PostMessageRequestWithQueriesQueryParams.  # noqa: E501
        :rtype: bool
        """
    ...
    def realtime(self, realtime):
        """Sets the realtime of this PostMessageRequestWithQueriesQueryParams.

        (defaults to true) - use false when migrating messages  # noqa: E501

        :param realtime: The realtime of this PostMessageRequestWithQueriesQueryParams.  # noqa: E501
        :type: bool
        """
    ...
    def notify_users(self):
        """Gets the notify_users of this PostMessageRequestWithQueriesQueryParams.  # noqa: E501

        (defaults to true) - use false when migrating messages  # noqa: E501

        :return: The notify_users of this PostMessageRequestWithQueriesQueryParams.  # noqa: E501
        :rtype: bool
        """
    ...
    def notify_users(self, notify_users):
        """Sets the notify_users of this PostMessageRequestWithQueriesQueryParams.

        (defaults to true) - use false when migrating messages  # noqa: E501

        :param notify_users: The notify_users of this PostMessageRequestWithQueriesQueryParams.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostMessageRequestWithQueriesQueryParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostMessageRequestWithQueriesQueryParams):
            return False
