...
class SentryIssueLinkObject(object):
    ...
    """
    swagger_types = {
        'metadata': 'SentryIssueLinkObjectMetadata'
    }
    ...
    def __init__(self, metadata=None):  # noqa: E501
        """SentryIssueLinkObject - a model defined in Swagger"""  # noqa: E501
        self._metadata = None
    ...
    @property
    def metadata(self):
        """Gets the metadata of this SentryIssueLinkObject.  # noqa: E501


        :return: The metadata of this SentryIssueLinkObject.  # noqa: E501
        :rtype: SentryIssueLinkObjectMetadata
        """
        return self._metadata

    @metadata.setter
    def metadata(self, metadata):
        """Sets the metadata of this SentryIssueLinkObject.


        :param metadata: The metadata of this SentryIssueLinkObject.  # noqa: E501
        :type: SentryIssueLinkObjectMetadata
        """
        if metadata is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SentryIssueLinkObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SentryIssueLinkObject):
            return False
