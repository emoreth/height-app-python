...
import six
from swagger_client.models.update_field_template_option_request import UpdateFieldTemplateOptionRequest  # noqa: F401,E501

class UpdateFieldTemplateOptionRequestWithId(UpdateFieldTemplateOptionRequest):
    ...
    if hasattr(UpdateFieldTemplateOptionRequest, "swagger_types"):
        swagger_types.update(UpdateFieldTemplateOptionRequest.swagger_types)

    attribute_map = {
        'id': 'id',
        'option_id': 'optionId'
    }
    if hasattr(UpdateFieldTemplateOptionRequest, "attribute_map"):
        attribute_map.update(UpdateFieldTemplateOptionRequest.attribute_map)

    def __init__(self, id=None, option_id=None, *args, **kwargs):  # noqa: E501
        """UpdateFieldTemplateOptionRequestWithId - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._option_id = None
        self.discriminator = None
        self.id = id
        self.option_id = option_id
        UpdateFieldTemplateOptionRequest.__init__(self, *args, **kwargs)

    @property
    def id(self):
        """Gets the id of this UpdateFieldTemplateOptionRequestWithId.  # noqa: E501


        :return: The id of this UpdateFieldTemplateOptionRequestWithId.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UpdateFieldTemplateOptionRequestWithId.


        :param id: The id of this UpdateFieldTemplateOptionRequestWithId.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def option_id(self):
        """Gets the option_id of this UpdateFieldTemplateOptionRequestWithId.  # noqa: E501


        :return: The option_id of this UpdateFieldTemplateOptionRequestWithId.  # noqa: E501
        :rtype: str
        """
    ...
    def option_id(self, option_id):
        """Sets the option_id of this UpdateFieldTemplateOptionRequestWithId.


        :param option_id: The option_id of this UpdateFieldTemplateOptionRequestWithId.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateFieldTemplateOptionRequestWithId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateFieldTemplateOptionRequestWithId):
            return False
