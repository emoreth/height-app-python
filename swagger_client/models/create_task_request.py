...
class CreateTaskRequest(object):
    ...
    swagger_types = {
        ...
        'order_intent': 'CreateTaskRequestOrderIntent'
    }
    ...
    def __init__(self, name=None, list_ids=None, description=None, status=None, assignees_ids=None, parent_task_id=None, fields=None, order_intent=None):  # noqa: E501
    ...
    @property
    def list_ids(self):
        """Gets the list_ids of this CreateTaskRequest.  # noqa: E501

        An array of UUIDs (one or more)  # noqa: E501

        :return: The list_ids of this CreateTaskRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def list_ids(self, list_ids):
        """Sets the list_ids of this CreateTaskRequest.

        An array of UUIDs (one or more)  # noqa: E501

        :param list_ids: The list_ids of this CreateTaskRequest.  # noqa: E501
        :type: list[str]
        """
        if list_ids is None:
    ...
    @property
    def status(self):
        """Gets the status of this CreateTaskRequest.  # noqa: E501


        :return: The status of this CreateTaskRequest.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this CreateTaskRequest.


        :param status: The status of this CreateTaskRequest.  # noqa: E501
        :type: str
        """
    ...
    def assignees_ids(self):
        """Gets the assignees_ids of this CreateTaskRequest.  # noqa: E501

        An array of UUIDs of the users assigned to the task (optional).  # noqa: E501

        :return: The assignees_ids of this CreateTaskRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def assignees_ids(self, assignees_ids):
        """Sets the assignees_ids of this CreateTaskRequest.

        An array of UUIDs of the users assigned to the task (optional).  # noqa: E501

        :param assignees_ids: The assignees_ids of this CreateTaskRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def parent_task_id(self):
        """Gets the parent_task_id of this CreateTaskRequest.  # noqa: E501

        The UUID of the parent task (optional).  # noqa: E501

        :return: The parent_task_id of this CreateTaskRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_task_id(self, parent_task_id):
        """Sets the parent_task_id of this CreateTaskRequest.

        The UUID of the parent task (optional).  # noqa: E501

        :param parent_task_id: The parent_task_id of this CreateTaskRequest.  # noqa: E501
        :type: str
        """
    ...
    def order_intent(self):
        """Gets the order_intent of this CreateTaskRequest.  # noqa: E501


        :return: The order_intent of this CreateTaskRequest.  # noqa: E501
        :rtype: CreateTaskRequestOrderIntent
        """
        return self._order_intent

    @order_intent.setter
    def order_intent(self, order_intent):
        """Sets the order_intent of this CreateTaskRequest.


        :param order_intent: The order_intent of this CreateTaskRequest.  # noqa: E501
        :type: CreateTaskRequestOrderIntent
        """
