...
class PatchTasksResponse(object):
    ...
    """
    swagger_types = {
        'list': 'list[OneOfPatchTasksResponseListItems]'
    }
    ...
    def __init__(self, list=None):  # noqa: E501
        """PatchTasksResponse - a model defined in Swagger"""  # noqa: E501
        self._list = None
    ...
    @property
    def list(self):
        """Gets the list of this PatchTasksResponse.  # noqa: E501


        :return: The list of this PatchTasksResponse.  # noqa: E501
        :rtype: list[OneOfPatchTasksResponseListItems]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this PatchTasksResponse.


        :param list: The list of this PatchTasksResponse.  # noqa: E501
        :type: list[OneOfPatchTasksResponseListItems]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksResponse):
            return False
