...
class SentryAlertLinkObject(object):
    ...
    """
    swagger_types = {
        'metadata': 'SentryAlertLinkObjectMetadata'
    }
    ...
    def __init__(self, metadata=None):  # noqa: E501
        """SentryAlertLinkObject - a model defined in Swagger"""  # noqa: E501
        self._metadata = None
    ...
    @property
    def metadata(self):
        """Gets the metadata of this SentryAlertLinkObject.  # noqa: E501


        :return: The metadata of this SentryAlertLinkObject.  # noqa: E501
        :rtype: SentryAlertLinkObjectMetadata
        """
        return self._metadata

    @metadata.setter
    def metadata(self, metadata):
        """Sets the metadata of this SentryAlertLinkObject.


        :param metadata: The metadata of this SentryAlertLinkObject.  # noqa: E501
        :type: SentryAlertLinkObjectMetadata
        """
        if metadata is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SentryAlertLinkObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SentryAlertLinkObject):
            return False
