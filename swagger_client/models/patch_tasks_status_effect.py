...
class PatchTasksStatusEffect(object):
    ...
    def __init__(self, type=None, status=None, completed_at=None):  # noqa: E501
        """PatchTasksStatusEffect - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._status = None
    ...
    @property
    def type(self):
        """Gets the type of this PatchTasksStatusEffect.  # noqa: E501


        :return: The type of this PatchTasksStatusEffect.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PatchTasksStatusEffect.


        :param type: The type of this PatchTasksStatusEffect.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def status(self):
        """Gets the status of this PatchTasksStatusEffect.  # noqa: E501
        ...
        :return: The status of this PatchTasksStatusEffect.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this PatchTasksStatusEffect.

        The status of the task. - `backLog` - `inProgress` - `done` - and any *UUID* of available statuses. You can find the *UUIDs* through the field template API.  # noqa: E501

        :param status: The status of this PatchTasksStatusEffect.  # noqa: E501
        :type: str
        """
        if status is None:
    ...
    def completed_at(self):
        """Gets the completed_at of this PatchTasksStatusEffect.  # noqa: E501

        ISO 8601 date-time  # noqa: E501

        :return: The completed_at of this PatchTasksStatusEffect.  # noqa: E501
        :rtype: datetime
        """
    ...
    def completed_at(self, completed_at):
        """Sets the completed_at of this PatchTasksStatusEffect.

        ISO 8601 date-time  # noqa: E501

        :param completed_at: The completed_at of this PatchTasksStatusEffect.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksStatusEffect, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksStatusEffect):
            return False
