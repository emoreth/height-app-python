...
class ListAllUsersResponse(object):
    ...
    def __init__(self, list=None):  # noqa: E501
        """ListAllUsersResponse - a model defined in Swagger"""  # noqa: E501
        self._list = None
    ...
    @property
    def list(self):
        """Gets the list of this ListAllUsersResponse.  # noqa: E501

        The list of users.  # noqa: E501

        :return: The list of this ListAllUsersResponse.  # noqa: E501
    ...
    @list.setter
    def list(self, list):
        """Sets the list of this ListAllUsersResponse.

        The list of users.  # noqa: E501

        :param list: The list of this ListAllUsersResponse.  # noqa: E501
        :type: list[UserObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListAllUsersResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllUsersResponse):
            return False
