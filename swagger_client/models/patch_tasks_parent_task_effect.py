...
class PatchTasksParentTaskEffect(object):
    ...
    def __init__(self, type=None, parent_task_id=None):  # noqa: E501
        """PatchTasksParentTaskEffect - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this PatchTasksParentTaskEffect.  # noqa: E501


        :return: The type of this PatchTasksParentTaskEffect.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PatchTasksParentTaskEffect.


        :param type: The type of this PatchTasksParentTaskEffect.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["parentTask"]  # noqa: E501
    ...
    def parent_task_id(self):
        """Gets the parent_task_id of this PatchTasksParentTaskEffect.  # noqa: E501

        The UUID of the parent task (optional).  # noqa: E501

        :return: The parent_task_id of this PatchTasksParentTaskEffect.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_task_id(self, parent_task_id):
        """Sets the parent_task_id of this PatchTasksParentTaskEffect.

        The UUID of the parent task (optional).  # noqa: E501

        :param parent_task_id: The parent_task_id of this PatchTasksParentTaskEffect.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksParentTaskEffect, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksParentTaskEffect):
            return False
