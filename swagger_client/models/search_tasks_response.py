...
class SearchTasksResponse(object):
    ...
    """
    swagger_types = {
        'list': 'list[OneOfSearchTasksResponseListItems]'
    }
    ...
    def __init__(self, list=None):  # noqa: E501
        """SearchTasksResponse - a model defined in Swagger"""  # noqa: E501
        self._list = None
    ...
    @property
    def list(self):
        """Gets the list of this SearchTasksResponse.  # noqa: E501


        :return: The list of this SearchTasksResponse.  # noqa: E501
        :rtype: list[OneOfSearchTasksResponseListItems]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this SearchTasksResponse.


        :param list: The list of this SearchTasksResponse.  # noqa: E501
        :type: list[OneOfSearchTasksResponseListItems]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchTasksResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchTasksResponse):
            return False
