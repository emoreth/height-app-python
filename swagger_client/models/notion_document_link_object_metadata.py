...
class NotionDocumentLinkObjectMetadata(object):
    ...
    def __init__(self, type=None, page_id=None):  # noqa: E501
        """NotionDocumentLinkObjectMetadata - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._page_id = None
    ...
    @property
    def type(self):
        """Gets the type of this NotionDocumentLinkObjectMetadata.  # noqa: E501

        The type of the metadata.  # noqa: E501

        :return: The type of this NotionDocumentLinkObjectMetadata.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this NotionDocumentLinkObjectMetadata.

        The type of the metadata.  # noqa: E501

        :param type: The type of this NotionDocumentLinkObjectMetadata.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["notionDocument"]  # noqa: E501
    ...
    @property
    def page_id(self):
        """Gets the page_id of this NotionDocumentLinkObjectMetadata.  # noqa: E501

        The ID of the Notion page.  # noqa: E501

        :return: The page_id of this NotionDocumentLinkObjectMetadata.  # noqa: E501
        :rtype: str
        """
    ...
    def page_id(self, page_id):
        """Sets the page_id of this NotionDocumentLinkObjectMetadata.

        The ID of the Notion page.  # noqa: E501

        :param page_id: The page_id of this NotionDocumentLinkObjectMetadata.  # noqa: E501
        :type: str
        """
        if page_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NotionDocumentLinkObjectMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotionDocumentLinkObjectMetadata):
            return False
