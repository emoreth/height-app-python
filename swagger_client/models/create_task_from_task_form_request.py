...
class CreateTaskFromTaskFormRequest(object):
    ...
    """
    swagger_types = {
        'answers': 'list[CreateTaskFromTaskFormRequestAnswers]'
    }
    ...
    def __init__(self, answers=None):  # noqa: E501
        """CreateTaskFromTaskFormRequest - a model defined in Swagger"""  # noqa: E501
        self._answers = None
    ...
    @property
    def answers(self):
        """Gets the answers of this CreateTaskFromTaskFormRequest.  # noqa: E501

        Array of question responses  # noqa: E501

        :return: The answers of this CreateTaskFromTaskFormRequest.  # noqa: E501
        :rtype: list[CreateTaskFromTaskFormRequestAnswers]
        """
        return self._answers

    @answers.setter
    def answers(self, answers):
        """Sets the answers of this CreateTaskFromTaskFormRequest.

        Array of question responses  # noqa: E501

        :param answers: The answers of this CreateTaskFromTaskFormRequest.  # noqa: E501
        :type: list[CreateTaskFromTaskFormRequestAnswers]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateTaskFromTaskFormRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTaskFromTaskFormRequest):
            return False
