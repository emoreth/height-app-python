...
class SentryIssueLinkObjectMetadataProject(object):
    ...
    def __init__(self, slug=None, id=None):  # noqa: E501
        """SentryIssueLinkObjectMetadataProject - a model defined in Swagger"""  # noqa: E501
        self._slug = None
        self._id = None
    ...
    @property
    def slug(self):
        """Gets the slug of this SentryIssueLinkObjectMetadataProject.  # noqa: E501

        The slug of the Sentry project.  # noqa: E501

        :return: The slug of this SentryIssueLinkObjectMetadataProject.  # noqa: E501
        :rtype: str
        """
        return self._slug
    ...
    @slug.setter
    def slug(self, slug):
        """Sets the slug of this SentryIssueLinkObjectMetadataProject.

        The slug of the Sentry project.  # noqa: E501

        :param slug: The slug of this SentryIssueLinkObjectMetadataProject.  # noqa: E501
        :type: str
        """
        if slug is None:
    ...
    @property
    def id(self):
        """Gets the id of this SentryIssueLinkObjectMetadataProject.  # noqa: E501

        The ID of the Sentry project.  # noqa: E501

        :return: The id of this SentryIssueLinkObjectMetadataProject.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SentryIssueLinkObjectMetadataProject.

        The ID of the Sentry project.  # noqa: E501

        :param id: The id of this SentryIssueLinkObjectMetadataProject.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SentryIssueLinkObjectMetadataProject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SentryIssueLinkObjectMetadataProject):
            return False
