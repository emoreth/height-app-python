...
import six
from swagger_client.models.create_task_request import CreateTaskRequest  # noqa: F401,E501

class CreateTaskRequestWithQueries(CreateTaskRequest):
    ...
    """
    swagger_types = {
        '_query_params': 'CreateTaskRequestWithQueriesQueryParams'
    }
    if hasattr(CreateTaskRequest, "swagger_types"):
        swagger_types.update(CreateTaskRequest.swagger_types)

    attribute_map = {
        '_query_params': 'queryParams'
    }
    if hasattr(CreateTaskRequest, "attribute_map"):
        attribute_map.update(CreateTaskRequest.attribute_map)

    def __init__(self, _query_params=None, *args, **kwargs):  # noqa: E501
        """CreateTaskRequestWithQueries - a model defined in Swagger"""  # noqa: E501
        self.__query_params = None
        self.discriminator = None
        if _query_params is not None:
            self._query_params = _query_params
        CreateTaskRequest.__init__(self, *args, **kwargs)

    @property
    def _query_params(self):
        """Gets the _query_params of this CreateTaskRequestWithQueries.  # noqa: E501


        :return: The _query_params of this CreateTaskRequestWithQueries.  # noqa: E501
        :rtype: CreateTaskRequestWithQueriesQueryParams
        """
        return self.__query_params

    @_query_params.setter
    def _query_params(self, _query_params):
        """Sets the _query_params of this CreateTaskRequestWithQueries.


        :param _query_params: The _query_params of this CreateTaskRequestWithQueries.  # noqa: E501
        :type: CreateTaskRequestWithQueriesQueryParams
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateTaskRequestWithQueries, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTaskRequestWithQueries):
            return False
