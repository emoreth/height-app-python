...
class PatchTasksListsEffect(object):
    ...
    swagger_types = {
        'type': 'str',
        'list_ids': 'list[PatchTasksAssigneesEffectAssigneesIds]'
    }
    ...
    def __init__(self, type=None, list_ids=None):  # noqa: E501
        """PatchTasksListsEffect - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._list_ids = None
    ...
    @property
    def type(self):
        """Gets the type of this PatchTasksListsEffect.  # noqa: E501


        :return: The type of this PatchTasksListsEffect.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PatchTasksListsEffect.


        :param type: The type of this PatchTasksListsEffect.  # noqa: E501
        :type: str
        """
        allowed_values = ["lists"]  # noqa: E501
    ...
    @property
    def list_ids(self):
        """Gets the list_ids of this PatchTasksListsEffect.  # noqa: E501

        An array of UUIDs  # noqa: E501

        :return: The list_ids of this PatchTasksListsEffect.  # noqa: E501
    ...
    def list_ids(self, list_ids):
        """Sets the list_ids of this PatchTasksListsEffect.

        An array of UUIDs  # noqa: E501

        :param list_ids: The list_ids of this PatchTasksListsEffect.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksListsEffect, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksListsEffect):
            return False
