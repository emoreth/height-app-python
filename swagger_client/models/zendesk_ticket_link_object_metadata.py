...
class ZendeskTicketLinkObjectMetadata(object):
    ...
    def __init__(self, type=None, ticket_id=None, subject=None, description=None):  # noqa: E501
        """ZendeskTicketLinkObjectMetadata - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this ZendeskTicketLinkObjectMetadata.  # noqa: E501

        The type of the metadata.  # noqa: E501

        :return: The type of this ZendeskTicketLinkObjectMetadata.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ZendeskTicketLinkObjectMetadata.

        The type of the metadata.  # noqa: E501

        :param type: The type of this ZendeskTicketLinkObjectMetadata.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["zendeskTicket"]  # noqa: E501
    ...
    @property
    def ticket_id(self):
        """Gets the ticket_id of this ZendeskTicketLinkObjectMetadata.  # noqa: E501

        The ID of the Zendesk ticket.  # noqa: E501

        :return: The ticket_id of this ZendeskTicketLinkObjectMetadata.  # noqa: E501
        :rtype: int
        """
    ...
    def ticket_id(self, ticket_id):
        """Sets the ticket_id of this ZendeskTicketLinkObjectMetadata.

        The ID of the Zendesk ticket.  # noqa: E501

        :param ticket_id: The ticket_id of this ZendeskTicketLinkObjectMetadata.  # noqa: E501
        :type: int
        """
    ...
    @property
    def subject(self):
        """Gets the subject of this ZendeskTicketLinkObjectMetadata.  # noqa: E501

        The subject of the Zendesk ticket.  # noqa: E501

        :return: The subject of this ZendeskTicketLinkObjectMetadata.  # noqa: E501
        :rtype: str
        """
    ...
    def subject(self, subject):
        """Sets the subject of this ZendeskTicketLinkObjectMetadata.

        The subject of the Zendesk ticket.  # noqa: E501

        :param subject: The subject of this ZendeskTicketLinkObjectMetadata.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ZendeskTicketLinkObjectMetadata.  # noqa: E501

        The description of the Zendesk ticket.  # noqa: E501

        :return: The description of this ZendeskTicketLinkObjectMetadata.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ZendeskTicketLinkObjectMetadata.

        The description of the Zendesk ticket.  # noqa: E501

        :param description: The description of this ZendeskTicketLinkObjectMetadata.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ZendeskTicketLinkObjectMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ZendeskTicketLinkObjectMetadata):
            return False
