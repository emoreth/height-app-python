...
class ListAllSecurityLogEventsResponse(object):
    ...
    """
    swagger_types = {
        'list': 'list[SecurityLogEventObject]'
    }
    ...
    def __init__(self, list=None):  # noqa: E501
        """ListAllSecurityLogEventsResponse - a model defined in Swagger"""  # noqa: E501
        self._list = None
    ...
    @property
    def list(self):
        """Gets the list of this ListAllSecurityLogEventsResponse.  # noqa: E501


        :return: The list of this ListAllSecurityLogEventsResponse.  # noqa: E501
        :rtype: list[SecurityLogEventObject]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this ListAllSecurityLogEventsResponse.


        :param list: The list of this ListAllSecurityLogEventsResponse.  # noqa: E501
        :type: list[SecurityLogEventObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListAllSecurityLogEventsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllSecurityLogEventsResponse):
            return False
