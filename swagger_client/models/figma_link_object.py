...
class FigmaLinkObject(object):
    ...
    swagger_types = {
        'url': 'str',
        'metadata': 'FigmaLinkObjectMetadata'
    }
    ...
    def __init__(self, url=None, metadata=None):  # noqa: E501
        """FigmaLinkObject - a model defined in Swagger"""  # noqa: E501
        self._url = None
        self._metadata = None
    ...
    @property
    def url(self):
        """Gets the url of this FigmaLinkObject.  # noqa: E501

        The URL of the Figma link.  # noqa: E501

        :return: The url of this FigmaLinkObject.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this FigmaLinkObject.

        The URL of the Figma link.  # noqa: E501

        :param url: The url of this FigmaLinkObject.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    @property
    def metadata(self):
        """Gets the metadata of this FigmaLinkObject.  # noqa: E501


        :return: The metadata of this FigmaLinkObject.  # noqa: E501
        :rtype: FigmaLinkObjectMetadata
        """
        return self._metadata

    @metadata.setter
    def metadata(self, metadata):
        """Sets the metadata of this FigmaLinkObject.


        :param metadata: The metadata of this FigmaLinkObject.  # noqa: E501
        :type: FigmaLinkObjectMetadata
        """
        if metadata is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FigmaLinkObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FigmaLinkObject):
            return False
