...
class UpdateListRequestAppearance(object):
    ...
    def __init__(self, icon=None, hue=None):  # noqa: E501
        """UpdateListRequestAppearance - a model defined in Swagger"""  # noqa: E501
        self._icon = None
        self._hue = None
    ...
    @property
    def icon(self):
        """Gets the icon of this UpdateListRequestAppearance.  # noqa: E501

        the name of the icon e.g. listCircles, listBug.  # noqa: E501

        :return: The icon of this UpdateListRequestAppearance.  # noqa: E501
        :rtype: str
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this UpdateListRequestAppearance.

        the name of the icon e.g. listCircles, listBug.  # noqa: E501

        :param icon: The icon of this UpdateListRequestAppearance.  # noqa: E501
        :type: str
        """
        if icon is None:
    ...
    @property
    def hue(self):
        """Gets the hue of this UpdateListRequestAppearance.  # noqa: E501


        :return: The hue of this UpdateListRequestAppearance.  # noqa: E501
        :rtype: float
        """
        return self._hue
    ...
    @hue.setter
    def hue(self, hue):
        """Sets the hue of this UpdateListRequestAppearance.


        :param hue: The hue of this UpdateListRequestAppearance.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateListRequestAppearance, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateListRequestAppearance):
            return False
