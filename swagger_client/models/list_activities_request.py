...
class ListActivitiesRequest(object):
    ...
    def __init__(self, task_id=None):  # noqa: E501
        """ListActivitiesRequest - a model defined in Swagger"""  # noqa: E501
        self._task_id = None
    ...
    @property
    def task_id(self):
        """Gets the task_id of this ListActivitiesRequest.  # noqa: E501

        Either the task unique `id` (UUID), or the task unique `index` (the 123 of T-123).  # noqa: E501

        :return: The task_id of this ListActivitiesRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        """Sets the task_id of this ListActivitiesRequest.

        Either the task unique `id` (UUID), or the task unique `index` (the 123 of T-123).  # noqa: E501

        :param task_id: The task_id of this ListActivitiesRequest.  # noqa: E501
        :type: str
        """
        if task_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListActivitiesRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListActivitiesRequest):
            return False
