...
class PatchTasksFieldsEffectFieldsLinkedTasksRemove(object):
    ...
    def __init__(self, id=None, index=None):  # noqa: E501
        """PatchTasksFieldsEffectFieldsLinkedTasksRemove - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._index = None
    ...
    @property
    def id(self):
        """Gets the id of this PatchTasksFieldsEffectFieldsLinkedTasksRemove.  # noqa: E501

        The ID for the task to remove.  # noqa: E501

        :return: The id of this PatchTasksFieldsEffectFieldsLinkedTasksRemove.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PatchTasksFieldsEffectFieldsLinkedTasksRemove.

        The ID for the task to remove.  # noqa: E501

        :param id: The id of this PatchTasksFieldsEffectFieldsLinkedTasksRemove.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def index(self):
        """Gets the index of this PatchTasksFieldsEffectFieldsLinkedTasksRemove.  # noqa: E501

        The index for the task to remove.  # noqa: E501

        :return: The index of this PatchTasksFieldsEffectFieldsLinkedTasksRemove.  # noqa: E501
        :rtype: int
        """
        return self._index
    ...
    def index(self, index):
        """Sets the index of this PatchTasksFieldsEffectFieldsLinkedTasksRemove.

        The index for the task to remove.  # noqa: E501

        :param index: The index of this PatchTasksFieldsEffectFieldsLinkedTasksRemove.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksFieldsEffectFieldsLinkedTasksRemove, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksFieldsEffectFieldsLinkedTasksRemove):
            return False
