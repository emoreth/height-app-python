...
class PatchTasksRequestPatches(object):
    ...
    def __init__(self, task_ids=None, effects=None):  # noqa: E501
        """PatchTasksRequestPatches - a model defined in Swagger"""  # noqa: E501
        self._task_ids = None
        self._effects = None
    ...
    @property
    def task_ids(self):
        """Gets the task_ids of this PatchTasksRequestPatches.  # noqa: E501

        Array of task ids, either UUIDs or task numbers  # noqa: E501

        :return: The task_ids of this PatchTasksRequestPatches.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def task_ids(self, task_ids):
        """Sets the task_ids of this PatchTasksRequestPatches.

        Array of task ids, either UUIDs or task numbers  # noqa: E501

        :param task_ids: The task_ids of this PatchTasksRequestPatches.  # noqa: E501
        :type: list[str]
        """
        if task_ids is None:
    ...
    @property
    def effects(self):
        """Gets the effects of this PatchTasksRequestPatches.  # noqa: E501


        :return: The effects of this PatchTasksRequestPatches.  # noqa: E501
        :rtype: list[OneOfPatchTasksRequestPatchesEffectsItems]
        """
        return self._effects

    @effects.setter
    def effects(self, effects):
        """Sets the effects of this PatchTasksRequestPatches.


        :param effects: The effects of this PatchTasksRequestPatches.  # noqa: E501
        :type: list[OneOfPatchTasksRequestPatchesEffectsItems]
        """
        if effects is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksRequestPatches, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksRequestPatches):
            return False
