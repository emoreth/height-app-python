...
class CreateTaskFromTaskFormRequestWithIdQueriesQueryParams(object):
    ...
    def __init__(self, as_bot=None):  # noqa: E501
        """CreateTaskFromTaskFormRequestWithIdQueriesQueryParams - a model defined in Swagger"""  # noqa: E501
        self._as_bot = None
        self.discriminator = None
        if as_bot is not None:
            self.as_bot = as_bot

    @property
    def as_bot(self):
        """Gets the as_bot of this CreateTaskFromTaskFormRequestWithIdQueriesQueryParams.  # noqa: E501

        Only allowed for public task forms, and required if not authenticated  # noqa: E501

        :return: The as_bot of this CreateTaskFromTaskFormRequestWithIdQueriesQueryParams.  # noqa: E501
        :rtype: bool
        """
        return self._as_bot

    @as_bot.setter
    def as_bot(self, as_bot):
        """Sets the as_bot of this CreateTaskFromTaskFormRequestWithIdQueriesQueryParams.

        Only allowed for public task forms, and required if not authenticated  # noqa: E501

        :param as_bot: The as_bot of this CreateTaskFromTaskFormRequestWithIdQueriesQueryParams.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateTaskFromTaskFormRequestWithIdQueriesQueryParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTaskFromTaskFormRequestWithIdQueriesQueryParams):
            return False
