...
class ListAllGroupsResponse(object):
    ...
    def __init__(self, list=None):  # noqa: E501
        """ListAllGroupsResponse - a model defined in Swagger"""  # noqa: E501
        self._list = None
    ...
    @property
    def list(self):
        """Gets the list of this ListAllGroupsResponse.  # noqa: E501


        :return: The list of this ListAllGroupsResponse.  # noqa: E501
        :rtype: list[GroupObject]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this ListAllGroupsResponse.


        :param list: The list of this ListAllGroupsResponse.  # noqa: E501
        :type: list[GroupObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListAllGroupsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllGroupsResponse):
            return False
