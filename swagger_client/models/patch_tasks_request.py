...
class PatchTasksRequest(object):
    ...
    """
    swagger_types = {
        'patches': 'list[PatchTasksRequestPatches]'
    }
    ...
    def __init__(self, patches=None):  # noqa: E501
        """PatchTasksRequest - a model defined in Swagger"""  # noqa: E501
        self._patches = None
    ...
    @property
    def patches(self):
        """Gets the patches of this PatchTasksRequest.  # noqa: E501


        :return: The patches of this PatchTasksRequest.  # noqa: E501
        :rtype: list[PatchTasksRequestPatches]
        """
        return self._patches

    @patches.setter
    def patches(self, patches):
        """Sets the patches of this PatchTasksRequest.


        :param patches: The patches of this PatchTasksRequest.  # noqa: E501
        :type: list[PatchTasksRequestPatches]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksRequest):
            return False
