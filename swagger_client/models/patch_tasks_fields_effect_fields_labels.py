...
class PatchTasksFieldsEffectFieldsLabels(object):
    ...
    """
    swagger_types = {
        'add': 'list[PatchTasksFieldsEffectFieldsLabelsAdd]',
        'remove': 'list[PatchTasksFieldsEffectFieldsLabelsRemove]'
    }
    ...
    def __init__(self, add=None, remove=None):  # noqa: E501
        """PatchTasksFieldsEffectFieldsLabels - a model defined in Swagger"""  # noqa: E501
        self._add = None
        self._remove = None
    ...
    @property
    def add(self):
        """Gets the add of this PatchTasksFieldsEffectFieldsLabels.  # noqa: E501


        :return: The add of this PatchTasksFieldsEffectFieldsLabels.  # noqa: E501
        :rtype: list[PatchTasksFieldsEffectFieldsLabelsAdd]
        """
        return self._add

    @add.setter
    def add(self, add):
        """Sets the add of this PatchTasksFieldsEffectFieldsLabels.


        :param add: The add of this PatchTasksFieldsEffectFieldsLabels.  # noqa: E501
        :type: list[PatchTasksFieldsEffectFieldsLabelsAdd]
        """
    ...
    @property
    def remove(self):
        """Gets the remove of this PatchTasksFieldsEffectFieldsLabels.  # noqa: E501


        :return: The remove of this PatchTasksFieldsEffectFieldsLabels.  # noqa: E501
        :rtype: list[PatchTasksFieldsEffectFieldsLabelsRemove]
        """
        return self._remove

    @remove.setter
    def remove(self, remove):
        """Sets the remove of this PatchTasksFieldsEffectFieldsLabels.


        :param remove: The remove of this PatchTasksFieldsEffectFieldsLabels.  # noqa: E501
        :type: list[PatchTasksFieldsEffectFieldsLabelsRemove]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksFieldsEffectFieldsLabels, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksFieldsEffectFieldsLabels):
            return False
