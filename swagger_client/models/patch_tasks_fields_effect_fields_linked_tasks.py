...
class PatchTasksFieldsEffectFieldsLinkedTasks(object):
    ...
    """
    swagger_types = {
        'add': 'list[PatchTasksFieldsEffectFieldsLinkedTasksAdd]',
        'remove': 'list[PatchTasksFieldsEffectFieldsLinkedTasksRemove]'
    }
    ...
    def __init__(self, add=None, remove=None):  # noqa: E501
        """PatchTasksFieldsEffectFieldsLinkedTasks - a model defined in Swagger"""  # noqa: E501
        self._add = None
        self._remove = None
    ...
    @property
    def add(self):
        """Gets the add of this PatchTasksFieldsEffectFieldsLinkedTasks.  # noqa: E501


        :return: The add of this PatchTasksFieldsEffectFieldsLinkedTasks.  # noqa: E501
        :rtype: list[PatchTasksFieldsEffectFieldsLinkedTasksAdd]
        """
        return self._add

    @add.setter
    def add(self, add):
        """Sets the add of this PatchTasksFieldsEffectFieldsLinkedTasks.


        :param add: The add of this PatchTasksFieldsEffectFieldsLinkedTasks.  # noqa: E501
        :type: list[PatchTasksFieldsEffectFieldsLinkedTasksAdd]
        """
    ...
    @property
    def remove(self):
        """Gets the remove of this PatchTasksFieldsEffectFieldsLinkedTasks.  # noqa: E501


        :return: The remove of this PatchTasksFieldsEffectFieldsLinkedTasks.  # noqa: E501
        :rtype: list[PatchTasksFieldsEffectFieldsLinkedTasksRemove]
        """
        return self._remove

    @remove.setter
    def remove(self, remove):
        """Sets the remove of this PatchTasksFieldsEffectFieldsLinkedTasks.


        :param remove: The remove of this PatchTasksFieldsEffectFieldsLinkedTasks.  # noqa: E501
        :type: list[PatchTasksFieldsEffectFieldsLinkedTasksRemove]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksFieldsEffectFieldsLinkedTasks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksFieldsEffectFieldsLinkedTasks):
            return False
