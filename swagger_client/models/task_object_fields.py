...
class TaskObjectFields(object):
    ...
    def __init__(self, field_template_id=None, value=None, _date=None, labels=None, linked_tasks=None):  # noqa: E501
        """TaskObjectFields - a model defined in Swagger"""  # noqa: E501
    ...
    def field_template_id(self):
        """Gets the field_template_id of this TaskObjectFields.  # noqa: E501

        The id of the appropriate field template  # noqa: E501

        :return: The field_template_id of this TaskObjectFields.  # noqa: E501
        :rtype: str
        """
    ...
    def field_template_id(self, field_template_id):
        """Sets the field_template_id of this TaskObjectFields.

        The id of the appropriate field template  # noqa: E501

        :param field_template_id: The field_template_id of this TaskObjectFields.  # noqa: E501
        :type: str
        """
    ...
    def value(self, value):
        """Sets the value of this TaskObjectFields.

        For text fields: the text value of the field. For select fields: the id of the selected option  # noqa: E501

        :param value: The value of this TaskObjectFields.  # noqa: E501
        :type: str
        """
    ...
    @property
    def _date(self):
        """Gets the _date of this TaskObjectFields.  # noqa: E501

        For date fields: the date value of the field  # noqa: E501

        :return: The _date of this TaskObjectFields.  # noqa: E501
        :rtype: datetime
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this TaskObjectFields.

        For date fields: the date value of the field  # noqa: E501

        :param _date: The _date of this TaskObjectFields.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this TaskObjectFields.  # noqa: E501

        For labels fields: the labels of the field  # noqa: E501

        :return: The labels of this TaskObjectFields.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this TaskObjectFields.

        For labels fields: the labels of the field  # noqa: E501

        :param labels: The labels of this TaskObjectFields.  # noqa: E501
        :type: list[str]
        """
    ...
    def linked_tasks(self):
        """Gets the linked_tasks of this TaskObjectFields.  # noqa: E501

        For linkedTasks fields: the tasks to be linked, in the format: { \"id\": \"UUID\", \"index\": number }  # noqa: E501

        :return: The linked_tasks of this TaskObjectFields.  # noqa: E501
    ...
    def linked_tasks(self, linked_tasks):
        """Sets the linked_tasks of this TaskObjectFields.

        For linkedTasks fields: the tasks to be linked, in the format: { \"id\": \"UUID\", \"index\": number }  # noqa: E501

        :param linked_tasks: The linked_tasks of this TaskObjectFields.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskObjectFields, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskObjectFields):
            return False
