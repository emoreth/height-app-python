...
class PostMessageRequest(object):
    ...
    def __init__(self, task_id=None, type=None, message=None):  # noqa: E501
        """PostMessageRequest - a model defined in Swagger"""  # noqa: E501
        self._task_id = None
        self._type = None
        self._message = None
    ...
    @property
    def task_id(self):
        """Gets the task_id of this PostMessageRequest.  # noqa: E501


        :return: The task_id of this PostMessageRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        """Sets the task_id of this PostMessageRequest.


        :param task_id: The task_id of this PostMessageRequest.  # noqa: E501
        :type: str
        """
        if task_id is None:
    ...
    @property
    def type(self):
        """Gets the type of this PostMessageRequest.  # noqa: E501


        :return: The type of this PostMessageRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PostMessageRequest.


        :param type: The type of this PostMessageRequest.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["comment", "description"]  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this PostMessageRequest.  # noqa: E501

        ## Mentions  Height supports multiple types of mentions, with each their own format:  User mention: `@user_<userId>`  Group mention: `@group_<groupId>`  Task mention: `T-<taskIndex>`  List mention: `#<listKey>`  # noqa: E501

        :return: The message of this PostMessageRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this PostMessageRequest.

        ## Mentions  Height supports multiple types of mentions, with each their own format:  User mention: `@user_<userId>`  Group mention: `@group_<groupId>`  Task mention: `T-<taskIndex>`  List mention: `#<listKey>`  # noqa: E501

        :param message: The message of this PostMessageRequest.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostMessageRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostMessageRequest):
            return False
