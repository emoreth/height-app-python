...
class CreateNormalListRequestAppearance(object):
    ...
    def __init__(self, icon=None, hue=None):  # noqa: E501
        """CreateNormalListRequestAppearance - a model defined in Swagger"""  # noqa: E501
        self._icon = None
        self._hue = None
    ...
    @property
    def icon(self):
        """Gets the icon of this CreateNormalListRequestAppearance.  # noqa: E501


        :return: The icon of this CreateNormalListRequestAppearance.  # noqa: E501
        :rtype: str
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this CreateNormalListRequestAppearance.


        :param icon: The icon of this CreateNormalListRequestAppearance.  # noqa: E501
        :type: str
        """
        if icon is None:
            raise ValueError("Invalid value for `icon`, must not be `None`")  # noqa: E501
        allowed_values = ["list", "listCircles", "listTriangle", "listSquare", "listLines", "listRectangles", "listCircle", "listRocket", "listMushroom", "listBolt", "listBug", "listFlower", "listThumbsUp", "listTarget", "listSparkle", "listMedal", "listFlag"]  # noqa: E501
    ...
    @property
    def hue(self):
        """Gets the hue of this CreateNormalListRequestAppearance.  # noqa: E501

        Hue is between 0 and 360 and used to determine the color.  If `null`, the list has no color.  # noqa: E501

        :return: The hue of this CreateNormalListRequestAppearance.  # noqa: E501
        :rtype: float
        """
        return self._hue
    ...
    @hue.setter
    def hue(self, hue):
        """Sets the hue of this CreateNormalListRequestAppearance.

        Hue is between 0 and 360 and used to determine the color.  If `null`, the list has no color.  # noqa: E501

        :param hue: The hue of this CreateNormalListRequestAppearance.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateNormalListRequestAppearance, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateNormalListRequestAppearance):
            return False
