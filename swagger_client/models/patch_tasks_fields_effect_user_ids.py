...
class PatchTasksFieldsEffectUserIds(object):
    ...
    def __init__(self, add=None, remove=None):  # noqa: E501
        """PatchTasksFieldsEffectUserIds - a model defined in Swagger"""  # noqa: E501
        self._add = None
        self._remove = None
    ...
    @property
    def add(self):
        """Gets the add of this PatchTasksFieldsEffectUserIds.  # noqa: E501


        :return: The add of this PatchTasksFieldsEffectUserIds.  # noqa: E501
        :rtype: list[str]
        """
        return self._add
    ...
    @add.setter
    def add(self, add):
        """Sets the add of this PatchTasksFieldsEffectUserIds.


        :param add: The add of this PatchTasksFieldsEffectUserIds.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def remove(self):
        """Gets the remove of this PatchTasksFieldsEffectUserIds.  # noqa: E501


        :return: The remove of this PatchTasksFieldsEffectUserIds.  # noqa: E501
        :rtype: list[str]
        """
        return self._remove
    ...
    def remove(self, remove):
        """Sets the remove of this PatchTasksFieldsEffectUserIds.


        :param remove: The remove of this PatchTasksFieldsEffectUserIds.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksFieldsEffectUserIds, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksFieldsEffectUserIds):
            return False
