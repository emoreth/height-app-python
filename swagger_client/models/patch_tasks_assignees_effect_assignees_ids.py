...
class PatchTasksAssigneesEffectAssigneesIds(object):
    ...
    def __init__(self, add=None, remove=None):  # noqa: E501
        """PatchTasksAssigneesEffectAssigneesIds - a model defined in Swagger"""  # noqa: E501
        self._add = None
        self._remove = None
    ...
    @property
    def add(self):
        """Gets the add of this PatchTasksAssigneesEffectAssigneesIds.  # noqa: E501


        :return: The add of this PatchTasksAssigneesEffectAssigneesIds.  # noqa: E501
        :rtype: list[str]
        """
        return self._add
    ...
    @add.setter
    def add(self, add):
        """Sets the add of this PatchTasksAssigneesEffectAssigneesIds.


        :param add: The add of this PatchTasksAssigneesEffectAssigneesIds.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def remove(self):
        """Gets the remove of this PatchTasksAssigneesEffectAssigneesIds.  # noqa: E501


        :return: The remove of this PatchTasksAssigneesEffectAssigneesIds.  # noqa: E501
        :rtype: list[str]
        """
        return self._remove
    ...
    def remove(self, remove):
        """Sets the remove of this PatchTasksAssigneesEffectAssigneesIds.


        :param remove: The remove of this PatchTasksAssigneesEffectAssigneesIds.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksAssigneesEffectAssigneesIds, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksAssigneesEffectAssigneesIds):
            return False
