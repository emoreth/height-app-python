...
class PatchTasksDescriptionEffect(object):
    ...
    swagger_types = {
        'type': 'str',
        'description': 'PatchTasksDescriptionEffectDescription'
    }
    ...
    def __init__(self, type=None, description=None):  # noqa: E501
        """PatchTasksDescriptionEffect - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this PatchTasksDescriptionEffect.  # noqa: E501


        :return: The type of this PatchTasksDescriptionEffect.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PatchTasksDescriptionEffect.


        :param type: The type of this PatchTasksDescriptionEffect.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["description"]  # noqa: E501
    ...
    def description(self):
        """Gets the description of this PatchTasksDescriptionEffect.  # noqa: E501


        :return: The description of this PatchTasksDescriptionEffect.  # noqa: E501
        :rtype: PatchTasksDescriptionEffectDescription
        """
        return self._description

    @description.setter
    def description(self, description):
        """Sets the description of this PatchTasksDescriptionEffect.


        :param description: The description of this PatchTasksDescriptionEffect.  # noqa: E501
        :type: PatchTasksDescriptionEffectDescription
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksDescriptionEffect, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksDescriptionEffect):
            return False
