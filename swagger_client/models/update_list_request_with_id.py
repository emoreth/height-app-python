...
import six
from swagger_client.models.update_list_request import UpdateListRequest  # noqa: F401,E501

class UpdateListRequestWithId(UpdateListRequest):
    ...
    if hasattr(UpdateListRequest, "swagger_types"):
        swagger_types.update(UpdateListRequest.swagger_types)

    attribute_map = {
        'id': 'id'
    }
    if hasattr(UpdateListRequest, "attribute_map"):
        attribute_map.update(UpdateListRequest.attribute_map)

    def __init__(self, id=None, *args, **kwargs):  # noqa: E501
        """UpdateListRequestWithId - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self.discriminator = None
        self.id = id
        UpdateListRequest.__init__(self, *args, **kwargs)

    @property
    def id(self):
        """Gets the id of this UpdateListRequestWithId.  # noqa: E501

        The id of the list  # noqa: E501

        :return: The id of this UpdateListRequestWithId.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UpdateListRequestWithId.

        The id of the list  # noqa: E501

        :param id: The id of this UpdateListRequestWithId.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateListRequestWithId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateListRequestWithId):
            return False
