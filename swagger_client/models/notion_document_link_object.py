...
class NotionDocumentLinkObject(object):
    ...
    swagger_types = {
        'url': 'str',
        'metadata': 'NotionDocumentLinkObjectMetadata'
    }
    ...
    def __init__(self, url=None, metadata=None):  # noqa: E501
        """NotionDocumentLinkObject - a model defined in Swagger"""  # noqa: E501
        self._url = None
        self._metadata = None
    ...
    @property
    def url(self):
        """Gets the url of this NotionDocumentLinkObject.  # noqa: E501

        The URL of the Notion document.  # noqa: E501

        :return: The url of this NotionDocumentLinkObject.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this NotionDocumentLinkObject.

        The URL of the Notion document.  # noqa: E501

        :param url: The url of this NotionDocumentLinkObject.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    @property
    def metadata(self):
        """Gets the metadata of this NotionDocumentLinkObject.  # noqa: E501


        :return: The metadata of this NotionDocumentLinkObject.  # noqa: E501
        :rtype: NotionDocumentLinkObjectMetadata
        """
        return self._metadata

    @metadata.setter
    def metadata(self, metadata):
        """Sets the metadata of this NotionDocumentLinkObject.


        :param metadata: The metadata of this NotionDocumentLinkObject.  # noqa: E501
        :type: NotionDocumentLinkObjectMetadata
        """
        if metadata is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NotionDocumentLinkObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotionDocumentLinkObject):
            return False
