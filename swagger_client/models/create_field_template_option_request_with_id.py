...
import six
from swagger_client.models.create_field_template_option_request import CreateFieldTemplateOptionRequest  # noqa: F401,E501

class CreateFieldTemplateOptionRequestWithId(CreateFieldTemplateOptionRequest):
    ...
    if hasattr(CreateFieldTemplateOptionRequest, "swagger_types"):
        swagger_types.update(CreateFieldTemplateOptionRequest.swagger_types)

    attribute_map = {
        'id': 'id'
    }
    if hasattr(CreateFieldTemplateOptionRequest, "attribute_map"):
        attribute_map.update(CreateFieldTemplateOptionRequest.attribute_map)

    def __init__(self, id=None, *args, **kwargs):  # noqa: E501
        """CreateFieldTemplateOptionRequestWithId - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self.discriminator = None
        self.id = id
        CreateFieldTemplateOptionRequest.__init__(self, *args, **kwargs)

    @property
    def id(self):
        """Gets the id of this CreateFieldTemplateOptionRequestWithId.  # noqa: E501


        :return: The id of this CreateFieldTemplateOptionRequestWithId.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CreateFieldTemplateOptionRequestWithId.


        :param id: The id of this CreateFieldTemplateOptionRequestWithId.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateFieldTemplateOptionRequestWithId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateFieldTemplateOptionRequestWithId):
            return False
