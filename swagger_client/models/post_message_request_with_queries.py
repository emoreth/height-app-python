...
import six
from swagger_client.models.post_message_request import PostMessageRequest  # noqa: F401,E501

class PostMessageRequestWithQueries(PostMessageRequest):
    ...
    """
    swagger_types = {
        '_query_params': 'PostMessageRequestWithQueriesQueryParams'
    }
    if hasattr(PostMessageRequest, "swagger_types"):
        swagger_types.update(PostMessageRequest.swagger_types)

    attribute_map = {
        '_query_params': 'queryParams'
    }
    if hasattr(PostMessageRequest, "attribute_map"):
        attribute_map.update(PostMessageRequest.attribute_map)

    def __init__(self, _query_params=None, *args, **kwargs):  # noqa: E501
        """PostMessageRequestWithQueries - a model defined in Swagger"""  # noqa: E501
        self.__query_params = None
        self.discriminator = None
        if _query_params is not None:
            self._query_params = _query_params
        PostMessageRequest.__init__(self, *args, **kwargs)

    @property
    def _query_params(self):
        """Gets the _query_params of this PostMessageRequestWithQueries.  # noqa: E501


        :return: The _query_params of this PostMessageRequestWithQueries.  # noqa: E501
        :rtype: PostMessageRequestWithQueriesQueryParams
        """
        return self.__query_params

    @_query_params.setter
    def _query_params(self, _query_params):
        """Sets the _query_params of this PostMessageRequestWithQueries.


        :param _query_params: The _query_params of this PostMessageRequestWithQueries.  # noqa: E501
        :type: PostMessageRequestWithQueriesQueryParams
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostMessageRequestWithQueries, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostMessageRequestWithQueries):
            return False
