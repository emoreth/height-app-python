...
class ListActivitiesResponse(object):
    ...
    def __init__(self, list=None):  # noqa: E501
        """ListActivitiesResponse - a model defined in Swagger"""  # noqa: E501
        self._list = None
    ...
    @property
    def list(self):
        """Gets the list of this ListActivitiesResponse.  # noqa: E501


        :return: The list of this ListActivitiesResponse.  # noqa: E501
        :rtype: list[ActivityObject]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this ListActivitiesResponse.


        :param list: The list of this ListActivitiesResponse.  # noqa: E501
        :type: list[ActivityObject]
        """
        if list is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListActivitiesResponse, dict):
