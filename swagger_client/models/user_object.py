...
import six
from swagger_client.models.enabled_user_object import EnabledUserObject  # noqa: F401,E501

class UserObject(EnabledUserObject):
    ...
    if hasattr(EnabledUserObject, "swagger_types"):
        swagger_types.update(EnabledUserObject.swagger_types)
    ...
    if hasattr(EnabledUserObject, "attribute_map"):
        attribute_map.update(EnabledUserObject.attribute_map)

    def __init__(self, id=None, model=None, state=None, email=None, access=None, created_at=None, picture_url=None, *args, **kwargs):  # noqa: E501
        ...
        EnabledUserObject.__init__(self, *args, **kwargs)
    ...
    @property
    def model(self):
        """Gets the model of this UserObject.  # noqa: E501

        The model is always `user`.  # noqa: E501

        :return: The model of this UserObject.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this UserObject.

        The model is always `user`.  # noqa: E501

        :param model: The model of this UserObject.  # noqa: E501
        :type: str
        """
        if model is None:
    ...
    @property
    def state(self):
        """Gets the state of this UserObject.  # noqa: E501

        The state of the user.  # noqa: E501

        :return: The state of this UserObject.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this UserObject.

        The state of the user.  # noqa: E501

        :param state: The state of this UserObject.  # noqa: E501
        :type: str
        """
        if state is None:
    ...
    @property
    def email(self):
        """Gets the email of this UserObject.  # noqa: E501

        The email of the user.  # noqa: E501

        :return: The email of this UserObject.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this UserObject.

        The email of the user.  # noqa: E501

        :param email: The email of this UserObject.  # noqa: E501
        :type: str
        """
        if email is None:
    ...
    @property
    def access(self):
        """Gets the access of this UserObject.  # noqa: E501


        :return: The access of this UserObject.  # noqa: E501
        :rtype: str
        """
        return self._access
    ...
    def access(self, access):
        """Sets the access of this UserObject.


        :param access: The access of this UserObject.  # noqa: E501
        :type: str
        """
        if access is None:
    ...
    @property
    def created_at(self):
        """Gets the created_at of this UserObject.  # noqa: E501
        ...
        :return: The created_at of this UserObject.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        ...
        :param created_at: The created_at of this UserObject.  # noqa: E501
        :type: datetime
        """
    ...
    def picture_url(self):
        """Gets the picture_url of this UserObject.  # noqa: E501

        The URL of the user's picture, if available.  # noqa: E501

        :return: The picture_url of this UserObject.  # noqa: E501
        :rtype: str
        """
    ...
    def picture_url(self, picture_url):
        """Sets the picture_url of this UserObject.

        The URL of the user's picture, if available.  # noqa: E501

        :param picture_url: The picture_url of this UserObject.  # noqa: E501
        :type: str
        """
