...
class PatchTasksAssigneesEffect(object):
    ...
    swagger_types = {
        'type': 'str',
        'assignees_ids': 'list[PatchTasksAssigneesEffectAssigneesIds]'
    }
    ...
    def __init__(self, type=None, assignees_ids=None):  # noqa: E501
        """PatchTasksAssigneesEffect - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this PatchTasksAssigneesEffect.  # noqa: E501


        :return: The type of this PatchTasksAssigneesEffect.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PatchTasksAssigneesEffect.


        :param type: The type of this PatchTasksAssigneesEffect.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["assignees"]  # noqa: E501
    ...
    def assignees_ids(self):
        """Gets the assignees_ids of this PatchTasksAssigneesEffect.  # noqa: E501

        An array of UUIDs of the users assigned to the task (optional).  # noqa: E501

        :return: The assignees_ids of this PatchTasksAssigneesEffect.  # noqa: E501
        :rtype: list[PatchTasksAssigneesEffectAssigneesIds]
        """
        return self._assignees_ids

    @assignees_ids.setter
    def assignees_ids(self, assignees_ids):
        """Sets the assignees_ids of this PatchTasksAssigneesEffect.

        An array of UUIDs of the users assigned to the task (optional).  # noqa: E501

        :param assignees_ids: The assignees_ids of this PatchTasksAssigneesEffect.  # noqa: E501
        :type: list[PatchTasksAssigneesEffectAssigneesIds]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchTasksAssigneesEffect, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTasksAssigneesEffect):
            return False
