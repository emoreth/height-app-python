...
import six
from swagger_client.models.update_task_request import UpdateTaskRequest  # noqa: F401,E501

class UpdateTaskRequestWithId(UpdateTaskRequest):
    ...
    if hasattr(UpdateTaskRequest, "swagger_types"):
        swagger_types.update(UpdateTaskRequest.swagger_types)

    attribute_map = {
        'id': 'id'
    }
    if hasattr(UpdateTaskRequest, "attribute_map"):
        attribute_map.update(UpdateTaskRequest.attribute_map)

    def __init__(self, id=None, *args, **kwargs):  # noqa: E501
        """UpdateTaskRequestWithId - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self.discriminator = None
        self.id = id
        UpdateTaskRequest.__init__(self, *args, **kwargs)

    @property
    def id(self):
        """Gets the id of this UpdateTaskRequestWithId.  # noqa: E501

        task index (number) or task id (UUID)  # noqa: E501

        :return: The id of this UpdateTaskRequestWithId.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UpdateTaskRequestWithId.

        task index (number) or task id (UUID)  # noqa: E501

        :param id: The id of this UpdateTaskRequestWithId.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateTaskRequestWithId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateTaskRequestWithId):
            return False
