...
class MoveTasksRequestOrderIntent(object):
    ...
    def __init__(self, intent=None, task_id=None):  # noqa: E501
        """MoveTasksRequestOrderIntent - a model defined in Swagger"""  # noqa: E501
        self._intent = None
        self._task_id = None
    ...
    @property
    def intent(self):
        """Gets the intent of this MoveTasksRequestOrderIntent.  # noqa: E501


        :return: The intent of this MoveTasksRequestOrderIntent.  # noqa: E501
        :rtype: str
        """
        return self._intent
    ...
    def intent(self, intent):
        """Sets the intent of this MoveTasksRequestOrderIntent.


        :param intent: The intent of this MoveTasksRequestOrderIntent.  # noqa: E501
        :type: str
        """
    ...
    @property
    def task_id(self):
        """Gets the task_id of this MoveTasksRequestOrderIntent.  # noqa: E501

        UUID (only used for before and after intent)  # noqa: E501

        :return: The task_id of this MoveTasksRequestOrderIntent.  # noqa: E501
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        """Sets the task_id of this MoveTasksRequestOrderIntent.

        UUID (only used for before and after intent)  # noqa: E501

        :param task_id: The task_id of this MoveTasksRequestOrderIntent.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MoveTasksRequestOrderIntent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MoveTasksRequestOrderIntent):
            return False
