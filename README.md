...
```sh
pip install git+https://github.com/emoreth/height-app-python.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/emoreth/height-app-python.git`)
